...
export default function Nav() {
  ...
  return (
    <header className="header">
      <nav className="flex items-center relative h-full w-full mx-0 my-auto px-8 py-4 bg-sombres-nav flex-wrap">
        ...
        <div className=" nav__components w-full flex items-center grow shrink flex-wrap">
          <div className="nav__links block grow pointer-events-auto  flex flex-wrap">
